...
// func consumeQueueCache(db *sql.DB, conn *amqp.Connection) {
//     for true{
...
//         )
//         failOnError(err, "Failed to declare an exchange")
//          fmt.Println("Success to declare an exchange")
//         q_cache, err := ch_cache.QueueDeclare(
//                 "cacheHit",    // name
//                 false, // durable
//                 false, // delete when unused
//                 false,  // exclusive
...
//         )
//         failOnError(err, "Failed to declare a queue")
//         fmt.Println("Success to declare a queue")
//         err = ch_cache.QueueBind(
//                 q_cache.Name, // queue name
//                 "Bitly_Trend",     // routing key
//                 "bitlyExchange_cache", // exchange
//                 false,
...
//         )
//         failOnError(err, "Failed to register a consumer")
//         fmt.Println("Success to register a consumer")
//         var body queueBody
